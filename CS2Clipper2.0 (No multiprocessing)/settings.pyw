...
class CS2ClipperSettings:
    ...
    def __init__(self, root):
        ...
        self.config_file = os.path.join(script_dir, "cs2clipper_config.json")
    ...
    def create_widgets(self):
        ...
        info_btn1 = ttk.Label(main_frame, text=" ℹ️", foreground="blue", cursor="hand2")
        ...
        info_btn2 = ttk.Label(main_frame, text=" ℹ️", foreground="blue", cursor="hand2")
        ...
        info_btn3 = ttk.Label(main_frame, text=" ℹ️", foreground="blue", cursor="hand2")
        ...
        # ===== RESOLUTION SETTINGS =====
        ttk.Label(main_frame, text="Video Resolution:", font=('Arial', 10, 'bold')).grid(
            row=current_row, column=0, sticky=tk.W, pady=(10, 5)
        )
        current_row += 1
        
        resolution_frame = ttk.Frame(main_frame)
        resolution_frame.grid(row=current_row, column=0, sticky=(tk.W, tk.E), pady=(0, 15))
        ...
        ttk.Spinbox(resolution_frame, from_=640, to=7680, textvariable=self.resolution_width_var, width=10).grid(
            row=0, column=1, padx=(10, 5), sticky=tk.W
        )
        ...
        ttk.Spinbox(resolution_frame, from_=480, to=4320, textvariable=self.resolution_height_var, width=10).grid(
            row=0, column=4, padx=(10, 5), sticky=tk.W
        )
        ...
        info_process_all = ttk.Label(process_all_frame, text=" ℹ️", foreground="blue", cursor="hand2")
        ...
        info_preview = ttk.Label(preview_label_frame, text=" ℹ️", foreground="blue", cursor="hand2")
