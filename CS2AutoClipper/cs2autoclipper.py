...
config_file = "cs2clipper_config.json"
default_config = {
...
for filename in os.listdir(video_folder):
    if filename.endswith('.mp4'):
        ...
        unsorted_files.append(os.path.join(video_folder, filename))
...
for video_index in range(num_videos_to_test):
    ...
    if not cap.isOpened():
        ...
        if should_trim:
            ...
            output_file = os.path.join(output_folder, filename.replace('.mp4', '_trimmed.mp4'))
